...
Conception of a methodology and its exemplarily implementation
}
...
Couplings dimensions            & The coupling dimensions that were used for the analysis (see \ref{sect:software-quality-metrics}) \\\hline

Couplings dimension weights     & The weights that were assigned to each of the utilized dimensions (see \ref{sect:merging-graphs}) \\\hline
...
\end{tabularx}
\caption{Explanation of the criteria of the experiments}
...
Instead the \textit{Average Mean Cluster Factor} metric is recorded:
\begin{itemize}[noitemsep]
...
This experiment was conducted as a mirroring of the second experiment while a
different metric was acquired:
\begin{itemize}[noitemsep]
    \item Coupling dimensions: semantic, evolutionary
    \item Coupling dimension weights: $1 \times semantic$, $1 \times evolutionary$
    \item Graph clustering algorithms: Chinese Whispers, Clauset-Newman-Moore, Infomap, Label Propagation, Louvain, MCL, Walktrap
    \item Maximum amount of iterations: 100
    \item Recorded metrics: \textit{Amount of Clusters}
\end{itemize}


\subsubsection{Experiment Nº 4}
Similarly, this experiment sets the same criteria as the last two ones while
recording the \textit{Ratio Inter-Cluster Edge Weights} metric:
\begin{itemize}[noitemsep]
    \item Coupling dimensions: semantic, evolutionary
    \item Coupling dimension weights: $1 \times semantic$, $1 \times evolutionary$
    \item Graph clustering algorithms: Chinese Whispers, Clauset-Newman-Moore, Infomap, Label Propagation, Louvain, MCL, Walktrap
    \item Maximum amount of iterations: 100
    \item Recorded metrics: \textit{Ratio Inter-Cluster Edge Weights}
\end{itemize}


\subsubsection{Experiment Nº 5}
In this last experiment we recorded the average of each metric per graph
...
\begin{sidewaysfigure}[p]
    ...
    \begin{axis}[
        ...
        symbolic x coords={
          ...
          AoC,  % Amount Of Clusters
          RICEW % Ratio Inter-Cluster Edge Weights
        },
        xtick=data,
        nodes near coords={
            \scriptsize{\pgfmathprintnumber[precision=0]{\pgfplotspointmeta}}
        }
    ]
    % Chinese Whispers
...
\end{adjustbox}
\caption{
  Plotted results of experiment Nº 1
}
\caption*{\centering\scriptsize
  The labels represent the following metrics:
  \begin{itemize}[noitemsep]
    \item AmCF/DmCF/SmCF/EmCF: Average/Dynamic/Semantic/Evolutionary Median Cluster Factor
...
The results of experiment Nº 2 can be found in figure \ref{fig:experiment-2}.
...
\begin{sidewaysfigure}[p]
    ...
    \begin{axis}[
        ...
        ylabel={Average Mean Cluster Factor ($\times100$)},
        symbolic x coords={
          Apache Solr,
          Google Bazel,
          Heritrix,
...
\end{adjustbox}
\caption{
  Plotted results of experiment Nº 2
}
...
The results of experiment Nº 3 can be found in figure \ref{fig:experiment-3}.
...
\end{adjustbox}
\caption{
  Plotted results of experiment Nº 3
}
...
\section{Experiment Nº 4}

The results of experiment Nº 4 can be found in figure \ref{fig:experiment-4}.
...
\end{adjustbox}
\caption{
  Plotted results of experiment Nº 4
}
...
\section{Experiment Nº 5}

The results of experiment Nº 5 can be found in figure \ref{fig:experiment-5}.
...
\begin{sidewaysfigure}[p]
    ...
    \begin{axis}[
        ...
        xtick=data,
        nodes near coords={
            \scriptsize{\pgfmathprintnumber[precision=1]{\pgfplotspointmeta}}
        }
    ]
    % Chinese Whispers
    \addplot [draw=none, fill=blue!60] coordinates {
      (Average of AmCF,14.5)
      (Average of AoC,700.8)
      (Average of RICEW,29.5)
    };
    % Clauset-Newman-Moore
    \addplot [draw=none, fill=magenta!60] coordinates {
      (Average of AmCF,64.5)
      (Average of AoC,40)
      (Average of RICEW,16.8)
    };
    % Infomap
    \addplot [draw=none, fill=green!60] coordinates {
      (Average of AmCF,54.2)
      (Average of AoC,21.7)
      (Average of RICEW,13.7)
    };
    % Label Propagation
    \addplot [draw=none, fill=cyan!60] coordinates {
      (Average of AmCF,48.7)
      (Average of AoC,171.2)
      (Average of RICEW,30.8)
    };
    % Louvain
    \addplot [draw=none, fill=red!60] coordinates {
      (Average of AmCF,65.7)
      (Average of AoC,35.5)
...
\end{adjustbox}
\caption{
  Plotted results of experiment Nº 5
}
\caption*{\centering\scriptsize
  The labels represent the following metrics:
  \begin{itemize}[noitemsep]
