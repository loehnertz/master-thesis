...
and there is a valley of data points in the lower left hand corner of figure
\ref{fig:experiment-2.3_Q}, for the preferred $Q$ metric, that achieves good
\textit{Ratio of Inter-Cluster Edge Weights (\%)} values while having very low
$Q$ scores at the same time.
