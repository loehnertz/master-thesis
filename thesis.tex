...
Just like with the \textit{dynamic coupling}, a directed and weighted graph
...
Again, a directed and weighted graph can be constructed out of the
...
However, we opted to discard weights and instead to construct a directed, unweighted graph.
...
Eventually, apart from the \textit{Girvan-Newman} algorithm, the first seven algorithms from table
...
\textit{dynamic coupling} dimension out of our experiments.
Nevertheless, the functionality was tested with example workloads
which still enables \textit{Steinmetz} to be used
...
of our \textit{\nameref{sect:evaluation}} as part of this thesis as an engineer
