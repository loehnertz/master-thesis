...
\newcommand{\thesisdate}{31/07/2020}
...
\paragraph{VCS mining} The repositories of
...
\section{Architecture} The general, high-level architecture of our application
...
\subsubsection{Relationships} One has to create a class annotated with \code{
...
class to the two vertices that it connects. Moreover, the \code{@Id} annotation
...
Moreover, similarly to \textit{Relationships} in \textit{Neo4j}, every \textit{
...
\ref{ogm-node}. Finally, the \textit{Nodes} as well as the \textit{Relationships}
...
Finally, the devised data models for our implementation are covered in this
...
Moreover, the \code{AbstractExtractor} and \code{ExtractorCompanion} are an
