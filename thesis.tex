...
In this third and last experiment we recorded the average of each metric per graph
...
\end{adjustbox}
\caption{
  First part of the plotted results of experiment Nº 2
}
...
\end{adjustbox}
\caption{
  Second part of the plotted results of experiment Nº 2
}
...
\end{adjustbox}
\caption{
  Third part of the plotted results of experiment Nº 2
}
...
\begin{sidewaysfigure}[p]
    ...
    \begin{axis}[
        ...
        xtick=data,
        nodes near coords={
            \tiny{\pgfmathprintnumber[precision=1]{\pgfplotspointmeta}}
        }
    ]
    % Chinese Whispers
    \addplot [draw=none, fill=blue!60] coordinates {
