...
\textit{inter-cluster edges} \cite{lancichinetti2009community} \cite{newman2004fast}.
...
\cite{clauset2004modularity} \cite{blondel2008modularity}
...
\cite{newman2004fast} \cite{fortunato2007resolution}.
...
\cite{fortunato2010community} \cite{danon2005comparing}.
...
wide-spread graph clustering algorithms \cite{lancichinetti2009community}.
...
\(Q\) the most, respectively decrease it the least, are merged
