...
(i.e., \code{W} from regular expressions), which is every character but a-z,
...
Java platform is lowered a bit, as the compiled native programs are platform\hyp
...
however, implements the \code{AbstractExtractor}. Within each of the sub\hyp
...
\hline
Solution & Static V & Semantic V & Evolutionary V & Static O & Semantic O & Evolutionary O & Average O & AOC & RICEW \\
\hline\hline
...
\caption*{\centering
  \begin{itemize}
    \item V: Variable
    \item O: Objective
    \item AOC: \textit{Amount of Clusters}
    \item RICEW: \textit{Ratio of Inter\hyp Cluster Edge Weights}
  \end{itemize}
}
