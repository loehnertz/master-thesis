...
The \textit{Modularization Quality} (MQ) metric calculates how good the cohesion
...
Thus, this set of metrics consists of ten metrics based on the and
\textit{Modularization Quality} and \textit{Modularity} metrics, introduced in
...
equation of calculating the \textit{Modularization Quality} or \textit{Modularity}
of their respective coupling graph (e.g. \(G_{semantic}\)).
The \textit{Average modularization quality} and the \textit{Average coupling modularity}
are the arithmetic means of the set of the first three metrics of their kind.
Lastly, the \textit{Total modularization quality} and \textit{Total coupling modularity}
