...
\newcommand{\secondmarker}{Stephan Schroevers, MSc.}
...
input fidelity}, that we defined, describes how many percent of the classes of
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{results/experiment_1-1}
